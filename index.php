    ...
    <header class="hover-header home-header-position">
        ...
        <nav class="header-nav flex-center">
            <ul class="header-list flex-center">
                <li><a href="pages/dorms.html" class="flex-center">Dorms</a></li>
                <li><a href="pages/page-wip.html" class="flex-center">About</a></li>
                <li><a href="pages/page-wip.html" class="flex-center">Contact</a></li>
            </ul>
        </nav>
    </header>
